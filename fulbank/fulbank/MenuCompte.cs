...
namespace fulbank
{
    public partial class MenuCompte : Form
    {
        ...
        /*private void BtnValider3_Click(object sender, EventArgs e)
        {
        ...
        private void Initializeform3()
        {
            ...
            panelCompte1.Size = new Size(1360, 300);  // Agrandir le panel 
            panelCompte1.Location = new Point(100, 40);  // Centré 
